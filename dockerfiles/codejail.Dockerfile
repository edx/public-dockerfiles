...
ENV DJANGO_SETTINGS_MODULE codejail_service.settings.production
...
ENV DJANGO_SETTINGS_MODULE codejail_service.settings.devstack
...
CMD while true; do python ./manage.py runserver 0.0.0.0:18030; sleep 2; done